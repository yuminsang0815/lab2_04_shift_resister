...
module tb_shift_register4;
    ...
    initial begin
        step; check(value===4'b0000, "reset"); rst=0; enable=1;
        ...
        repeat(4) step; check(value===4'b0000, "flush with four zeros");
        serial_in=1; rst=1; step; check(value===4'b0000, "reset priority");
        finish;
    end
endmodule